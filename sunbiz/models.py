...
class OriEncumbrance(Base):
    ...
    encumbrance_type: Mapped[str] = mapped_column(Text, nullable=False, server_default=text("'other'"))
    ...
    is_satisfied: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default=text("false"))
...
class ForeclosureTitleEvent(Base):
    ...
    foreclosure_id: Mapped[int] = mapped_column(
        BigInteger, ForeignKey("foreclosures.foreclosure_id", ondelete="CASCADE"), nullable=False,
    )
    case_number_raw: Mapped[str] = mapped_column(Text, nullable=False)
    case_number_norm: Mapped[str | None] = mapped_column(Text)
    folio: Mapped[str | None] = mapped_column(Text)
...
class ForeclosureTitleChain(Base):
    ...
    acquired_event_id: Mapped[int | None] = mapped_column(
        BigInteger, ForeignKey("foreclosure_title_events.id", ondelete="CASCADE"),
    )
    next_event_id: Mapped[int | None] = mapped_column(
        BigInteger, ForeignKey("foreclosure_title_events.id", ondelete="SET NULL"),
    )
